class WebGLGalaxy {
    ...
    init() {
        ...
        // Force initial resize and wait for next frame to ensure proper initialization
        this.resize();
        
        // Use requestAnimationFrame to ensure canvas is properly sized before creating shaders
        requestAnimationFrame(() => {
            ...
            // Force another resize after a short delay to ensure everything is properly initialized
            setTimeout(() => {
                this.resize();
            }, 100);
        });
    ...
    createGeometry() {
        ...
        // Set uniforms
        this.setUniform('uFocal', '2f', this.options.focal);
        this.setUniform('uRotation', '2f', this.options.rotation);
        this.setUniform('uStarSpeed', '1f', this.options.starSpeed);
        ...
        this.setUniform('uAutoCenterRepulsion', '1f', this.options.autoCenterRepulsion);
    ...
    addEventListeners() {
        ...
        // Removed resize listener to prevent resizing
    }
    ...
    animate() {
        ...
        this.setUniform('uStarSpeed', '1f', (time * this.options.starSpeed) / 10.0);
